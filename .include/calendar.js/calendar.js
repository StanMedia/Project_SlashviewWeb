/*!
 * Original: JJonline / https://github.com/jjonline/calendar.js / v1.0.3
 * Modify: Slashview 繁體中文 / 台灣化 / 部分程式碼簡化
 */
var calendar = (function() {
  ...
  var solarTerm = ["小寒", "大寒", "立春", "雨水", "驚蟄", "春分", "清明", "谷雨", "立夏", "小滿", "芒種", "夏至", "小暑", "大暑", "立秋", "處暑", "白露", "秋分", "寒露", "霜降", "立冬", "小雪", "大雪", "冬至"];
  ...
  var calendar = {
    ...
    toAstro: function toAstro(cMonth, cDay) {
      var s = "摩羯水瓶雙魚白羊金牛雙子巨蟹獅子處女天秤天蠍射手摩羯";
      var arr = [20, 19, 21, 21, 21, 22, 23, 23, 23, 23, 22, 22];
      var iStartIndex = cMonth * 2 - (cDay < arr[cMonth - 1] ? 2 : 0);
      return s.substring(iStartIndex, iStartIndex+2) + "座";
    },
    ...
    getTerm: function getTerm(y, n) {
      ...
      for (var index = 0; index < _table.length; index += 5) {
        var chunk = parseInt('0x' + _table.substring(index, index+5)).toString();
        _calcDay.push(chunk[0], chunk.substring(1, 3), chunk[3], chunk.substring(4, 6));
      }
